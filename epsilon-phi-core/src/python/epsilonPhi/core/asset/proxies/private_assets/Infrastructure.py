...
class CInfrastructure(CPrivateAsset):
    ...
    def __init__(self, schema, **kwargs):
        pme = kwargs.pop('data', schema.get_asset_from_name(CInfrastructure._pme_name))
        CPrivateAsset.__init__(self, pme, schema, CInfrastructure._asset_name)
        self.set_reporting_info(CInfrastructure._reporting_name, CInfrastructure._category)
