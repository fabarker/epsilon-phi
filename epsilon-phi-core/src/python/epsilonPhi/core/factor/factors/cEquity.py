...
class cEquity(CFactor):
    def __init__(self,
        ...
        super(cEquity, self).__init__(data=data,
                                      ts_type=ts_type,
    ...
    def construct_factor(frequency):
        ...
        # Local Equity Market
        EQ_L = gds.get_total_return_series_from_ticker('MSWRLDL').get_periodic_returns(frequency, ReturnsType.SIMPLE)
        rfr_L = gds.get_risk_free_rate_time_series('World').get_periodic_returns(frequency, ReturnsType.SIMPLE)
