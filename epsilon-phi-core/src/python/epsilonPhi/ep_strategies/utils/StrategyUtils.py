...
class StrategyUtils(object):
    ...
    @staticmethod
    def estimate_bid_ask_prices(open: np.array,
                                high: np.array,
                                low: np.array,
                                close: np.array,
                                sign: bool = False) -> float:

        spread_pct = StrategyUtils.estimate_price_spread_percentage(open, high, low, close, sign)
    ...
    @staticmethod
    def estimate_price_spread_percentage(open: np.array,
                                        high: np.array,
                                        low: np.array,
                                        close: np.array,
                                        sign: bool = False) -> float:
